...
**Notifications:** always sends a WhatsApp end-of-day summary, regardless of whether a trade
happened.
...
Then send a WhatsApp end-of-day summary via scripts/whatsapp.py covering: today's P/L, any
