...
_Last updated: 2026-07-14 ~08:00 ET (pre-market routine; research/drafting only, NO trades. Regime: **THE binary RESOLVED — June CPI IN LINE / benign (core +2.9% y/y, +0.2% m/m; headline ~3.9% on a ~10% gasoline drop)** → status-quo hawkish Fed, muted reaction; gate (a) CPI-benign MET. BUT the **Iran/Hormuz oil shock ESCALATED to day-3**: **Brent +~13% in two sessions to ~$86.54 (1-month high)**, Trump imposed 20% Hormuz shipping fees + reinstated Iranian port blockade → gate (b) "oil stabilizing" FAILS. So the two-part deploy trigger is now HALF-met: **falling-knife still binds on the geopolitical driver; deployment stays gated, but the gate has NARROWED to JUST oil/Iran** (CPI benign + NVDA B200 lease still firm ~$6). Tape MIXED, chips steadying (Nasdaq-100 fut +0.48%, SOX +2.4% after Mon -1.6%); bank earnings pre-open (JPM/GS/WFC/C) + Warsh testimony today; TSMC Thu 7/16. Staying ~93% cash is a DELIBERATE logged decision. **NVDA = primary tech deployable once oil reverses/stabilizes** (do NOT initiate today). Trigger for any starter: oil/Iran stabilizing (≥1 up day OR oil reversing) AND tight live spread. FDX doubly-wrong (oil +13% fuel headwind + spread-gated). META +12.47% at target weight, 7% trail (never loosen); MRK -1.93% doing its defensive job — NEW: Guggenheim PT $145 / BMO $142 on Keytruda Qlex uptake. Weekly slots: 1 of 3 used (MRK).)_
...
- **META** — HOLD, **add COMPLETE — no further add.** 7 sh @ $578.45 blended, **+12.47%** (~$650.58), ~**4.5% of equity = target weight** (below 5% cap). Thesis STRENGTHENED (best week since early 2024, +21% in 3 wks): BofA (Justin Post) flags cost savings — capacity cost/MW "well below Street expectations"; **Muse Spark 1.1 API = first external AI monetization, priced ~25% of OpenAI/Anthropic**; Iris chip mfg starts Sept (toward 14 GW '27). Buy consensus, avg PT $836.76. Lone caution: "overbought." Standing bear: $125-145B 2026 capex. No binary until earnings Jul 29. 7% trail live (never loosen). Add only on a material pullback + fresh catalyst. (2026-07-14)
...
- **MRK** *(non-tech — NOW A HOLDING, opened 2026-07-09)* — **BOUGHT 23 sh @ $125.90 (~2.88%, 10% trail) on the 7/9 open** as the deployment-floor defensive starter (oil-insensitive, low-tech-correlation → the clean deploy into a hawkish-Fed + war/oil tape). Catalysts: **KEYTRUDA FDA approvals (TNBC + bladder), positive Ph3 tulisokibart (UC); HSBC PT $150 (Buy), Scotiabank $155 (Outperform)**; Buy consensus (29 analysts). Entry ~$126, now ~$123.47 (-1.93%). Earnings Aug 4. Risk: 2028 Keytruda patent cliff (~half of pharma rev). **NEW (7/13): Guggenheim raised PT to $145 (Buy), BMO to $142 (OP) on strong Keytruda Qlex uptake** (BMO est $363M Q2 vs $334M consensus); permanent J-code secured Q2. Oil-INSENSITIVE defensive → doing its job on the oil-spike tape. HOLD — manage per stop rules; add only on a fresh catalyst/pullback. (2026-07-14)
- **NVDA** — **PRIMARY tech deployable — gate NARROWED to just oil/Iran (2026-07-14).** Two of the three 7/13 gates have CLEARED: (a) **CPI printed IN LINE/benign** (core +2.9%, muted), and the **B200 lease gate is FIRM** — Northflank $5.87/hr, median ~$6 (range $2.69→$18.53); providers guide $2.50-3.00 by Q4. Chips steadying pre-mkt (SOX +2.4%). **The ONLY remaining gate is the escalating oil/Iran shock** (Brent +13% two sessions to ~$86, Hormuz blockade reinstated, day-3) — falling-knife still binds on that. **Do NOT initiate today.** Trigger: initiate a ~3% starter (fresh 10% trail, a FRESH slot) ONLY IF oil/Iran stabilizes (≥1 up day OR oil reversing) AND a live spread re-sampled 2-3x is tight. Highest-priority tech watch. (2026-07-14)
