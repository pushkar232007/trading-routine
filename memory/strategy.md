...
- **MRK** *(non-tech — PRIMARY deployable for today's tape)* — real catalysts: **KEYTRUDA FDA approvals (TNBC + bladder), positive Ph3 tulisokibart (UC); HSBC PT $150 (Buy), Scotiabank $155 (Outperform)**; Buy consensus (29 analysts). **Defensive pharma, oil-insensitive, low AI/rate-correlation → the CLEANEST deploy into a hawkish-Fed tape.** **CAVEAT (new): ~$129 now (run up ~5%), so consensus avg PT $131.67 = only ~2% upside — "valuation has caught up" (HSBC/Scotia are the bull outliers).** So this is a DEFENSIVE-DIVERSIFIER starter, not a deep-value buy — size accordingly. Earnings Aug 4. Risk: 2028 Keytruda patent cliff (~half of pharma rev). Still spread-gated. (2026-07-09)
