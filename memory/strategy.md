...
_Last updated: 2026-07-13 09:33 ET (market-open Mon; NO trades — fresh Iran/oil geopolitical RISK-OFF open: US renewed Strait-of-Hormuz strikes over the weekend, Iran retaliated vs US allies (Kuwait/Jordan/Qatar), oil jumping; futures red (Dow -0.1%/S&P -0.3%/Nasdaq-100 -0.8%), ~22% odds of an up open — reversing a strong Fri 7/11 close (S&P +0.42% 7,575). **Falling-knife rule BINDS** → no new positions into an unconfirmed shock. No fresh pre-market plan existed today (a Fri 7/10 routine ran & tightened META's stop to 7% on the broker but never committed to main — reconciled live from broker). HOLD META (+14.91%, best week since early 2024 on Meta Compute/Muse/Iris; 4.63% weight, 7% trail, no add/no chase) + MRK (-2.07%, defensive book doing its job on an oil-spike day). FDX still spread-gated (6.6%, frozen feed) + oil-wrong; NVDA gate unconfirmed. New week 7/13 → 0 of 3 slots used. Deployment-floor = deliberate cash logged. This week: bank earnings/TSMC/NFLX/UNH.)_
