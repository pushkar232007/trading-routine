...
_Last updated: 2026-07-13 12:30 ET (pre-market routine, fired LATE mid-session; research/drafting only, NO trades. Regime: **day-1 of an unconfirmed Iran/oil shock** — Trump reimposed the Hormuz blockade, ceasefire/MoU collapsed, **Brent +4% to $78.82 (highest since 6/22)**; S&P -0.4%/Nasdaq -1%, AI under pressure, reversing a strong Fri 7/11 (S&P 7,575 +0.42%). **Falling-knife rule BINDS.** And a **double-binary lands TOMORROW AM: June CPI Tue 7/14 8:30 ET** (headline ~3.9% y/y on a ~10% gasoline drop, but CORE sticky ~2.9% = the Fed-gate; "most important data point of the year") **+ big-bank earnings pre-open (JPM/GS/BAC/WFC/C)**; Wed MS/BLK; **Thu 7/16 TSMC (AI-demand read) + NFLX + UNH + JNJ**. Deployment stays gated — staying ~92% cash into the open is a DELIBERATE logged decision. **NVDA UPGRADED within-watch — B200 lease median recovered to $6.11 (matching May pre-drop) → lease gate FIRMING** — but still don't initiate into an oil-shock + pre-CPI tape; re-check post-CPI. Trigger for any starter: CPI benign (core ≤~2.9%) AND oil/Iran stabilizing AND tight live spread. FDX spread-gated (6.6% frozen) + oil-wrong. META +14.91% at target weight, 7% trail (never loosen); MRK -2.07% doing its defensive job (new Keytruda+Padcev bladder FDA approval, WF PT $150). New week 7/13 → 0 of 3 slots used.)_
...
- **NVDA** — **UPGRADED within-watch (2026-07-13) — lease gate FIRMING, but do NOT initiate yet.** **B200 lease median RECOVERED to $6.11** (range $3.44 Vast → $16.11 GCP), matching the May-30 pre-drop level → the -31%-to-$4.22 crack has fully reversed; the "lease stabilization" gate that blocked this name since 6/26 is now FIRMING. Quote tight (~$209.74, 0.02% spread on 7/13 AM). Still gated for THREE reasons today: (a) day-1 unconfirmed oil-shock/AI-risk-off tape, (b) June CPI binary Tue 7/14, (c) no clean base. **Re-check post-CPI** — this is the primary tech deployable IF CPI prints benign + oil stabilizes. Highest-priority tech watch; a buy is a FRESH slot. (2026-07-13)
